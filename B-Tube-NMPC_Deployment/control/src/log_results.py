...
class DataLogger(Node):
    def __init__(self):
        ...
        self.left_front_sub = self.create_subscription(Int32, '/io/motor/front_left/speed', self.left_front_callback, 10)
        self.right_front_sub = self.create_subscription(Int32, '/io/motor/front_right/speed', self.right_front_callback, 10)
        self.left_rear_sub = self.create_subscription(Int32, '/io/motor/rear_left/speed', self.left_rear_callback, 10)
        self.right_rear_sub = self.create_subscription(Int32, '/io/motor/rear_right/speed', self.right_rear_callback, 10)
        ...
        self.nominal_sub = self.create_subscription(PoseStamped, '/nominal_trajectory', self.nominal_callback, 10)
        self.last_nominal = {'x': 0.0, 'y': 0.0, 'yaw': 0.0}
        ...
        'X_ref', 'Y_ref', 'Yaw_ref', 'X_nom', 'Y_nom', 'Yaw_nom'
    ])
...
def main():
    ...
    try:
        ...
        # Handle Ctrl+C
        data_logger.get_logger().info('Keyboard Interrupt detected! Shutting down...')
    finally:
